...
Make sure you installed the latest [.NET Core 3.1.2 SDK](https://dotnet.microsoft.com/download/dotnet-core/3.1).

All these samples runs on Blazor WebAssembly 3.2.0 Preview 3.
