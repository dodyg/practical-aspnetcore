# 131 samples for aspnetcore fundamentals (updated daily)
...
There are dedicated samples for ASP.NET Core MVC 2.1 [here (4 samples)](/projects/mvc), ASP.NET Core Signal R 2.1 [here (0 sample)](/projects/signalr) and Blazor [here (0 sample)](/projects/blazor). The rest of projects here are for ASP.NET Core only.
