# 152 samples for ASP.NET Core 2.1 fundamentals (updated daily)
...
There are dedicated samples for ASP.NET Core MVC 2.1 [here (17 samples)](/projects/mvc), ASP.NET Core SignalR 2.1 [here (0 sample)](/projects/signalr) and Blazor [here (1 sample)](/projects/blazor). The rest of projects here are for ASP.NET Core only.
