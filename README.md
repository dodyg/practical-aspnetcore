# Samples for ASP.NET Core 3.1.300 (308)
...
**Note** There is a section containing **.NET 5 Preview 7** specific samples [here](/projects/5-0) (33). For samples for older version of ASP.NET Core (e.g 2.1), you can find them [here](https://github.com/dodyg/practical-aspnetcore/tree/2.1-LTS).
