# 204 samples for ASP.NET Core 2.1 and 2.2 fundamentals (updated almost daily - except during Summer)
...
There are dedicated samples for **ASP.NET Core MVC 2.1** [here (36 samples)](/projects/mvc/README.md), ASP.NET Core SignalR 2.1 [here (0 sample)](/projects/signalr) and Blazor [here (9 samples)](/projects/blazor/README.md). The rest of projects here are for ASP.NET Core only.
