# 304 samples for ASP.NET Core 2.1, 2.2 and 3.0-preview-9 fundamentals (updated almost daily - except during Summer)
...
| ------- | ------- | ------- |
| [ASP.NET Core 3.0](/projects/3-0) | 56 | 3.0-preview-9 |
