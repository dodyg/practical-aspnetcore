# 210 samples for ASP.NET Core 2.1 and 2.2 fundamentals (updated almost daily - except during Summer)
...
There are dedicated samples for **ASP.NET Core MVC 2.1** [here (39 samples)](/projects/mvc/README.md), ASP.NET Core SignalR 2.1 [here (1 sample)](/projects/signalr/README.md) and Blazor [here (11 samples)](/projects/blazor/README.md). The rest of projects here are for ASP.NET Core only.
...
* **Middleware (10)**
  ...
  * [Middleware 11](https://github.com/dodyg/practical-aspnetcore/tree/master/projects/middleware-11)
