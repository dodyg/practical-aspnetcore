# 285 samples for ASP.NET Core 2.1, 2.2 and 3.0-preview-7 fundamentals (updated almost daily - except during Summer)
...
| ------- | ------- | ------- |
| [ASP.NET Core 3.0](/projects/3-0) | 39 | 3.0-preview-7 |
